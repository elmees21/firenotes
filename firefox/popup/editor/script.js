document.addEventListener("DOMContentLoaded", function() {
    ...
    const chatLinkButton = document.getElementById("chat-link");
    function darkMode() {
    }
    ...
    resetButton.addEventListener("click", function() {
        const confirmReset = window.confirm(browser.i18n.getMessage("deleteWarning"));
        if (confirmReset) {
            localStorage.clear();
            noteText.value = "";
